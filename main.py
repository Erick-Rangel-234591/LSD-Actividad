...
app.include_router(pagos.router, prefix="/pagos", tags=["Equipo 7 - Pagos"])
app.include_router(envios.router, prefix="/envios", tags=["Equipo 8 - Envíos"])
app.include_router(resenas.router, prefix="/resenas", tags=["Equipo 9 - Reseñas"])
